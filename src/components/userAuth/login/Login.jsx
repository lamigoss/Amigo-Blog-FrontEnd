      ...
      <div className="bg-white bg-opacity-75 text-black shadow-lg rounded-md p-10 xs:w-10/12 sm:w-8/12 msm:w-7/12 md:w-6/12 laptop:w-5/12 desktop:w-4/12 lg:w-3/12">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-rows">
            ...
            />
            <button
               className="w-1/2 px-10 sm:px-8 p-2 text-white transition duration-300 rounded-md hover:from-indigo-500 hover:to-blue-500 ease bg-gradient-to-br from-blue-400 to-indigo-400 justify-self-center mt-6 shadow-lg"
              type="submit"
            >
              Login
            </button>
